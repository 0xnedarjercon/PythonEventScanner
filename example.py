...
if __name__ == "__main__":
    ...
    RCC_ADDRESS = "0x07F9F7f963C5cD2BBFFd30CcfB964Be114332E30"
    ...
    ABI = """[
  {
    ...
    def run():
        api_url = "https://mainnet.aurora.dev"
        ...
        start_block = 90674400  # max(state.get_last_scanned_block() - chain_reorg_safety_blocks, 0)
        end_block = 90674405  # scanner.get_suggested_scan_end_block()
